 ...
 *  Sounds effects for the dragon's mouth for water
 *
 */
public class SoundEffectBreathWeaponWater extends SoundEffectBreathWeapon
{
  public SoundEffectBreathWeaponWater(SoundController i_soundController, WeaponSoundUpdateLink i_weaponSoundUpdateLink)
  {
...
//                                      SoundEffectName.ADULT_BREATHE_FIRE_STOP};
    ...
    switch (soundPart) {
      case START: {
        soundEffectNames = SoundEffectName.BREATHE_WATER_START;
        break;
      }
      case LOOP: {
        soundEffectNames = SoundEffectName.BREATHE_WATER_LOOP;
        break;
      }
      case STOP: {
        soundEffectNames = SoundEffectName.BREATHE_WATER_STOP;
        break;
      }
      default: {
