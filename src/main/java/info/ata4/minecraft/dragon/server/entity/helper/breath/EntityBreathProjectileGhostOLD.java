...
// */
//public class EntityBreathProjectileGhostOLD extends EntityBreathProjectile {
//
//  public EntityBreathProjectileGhostOLD(World worldIn, EntityLivingBase shooter,
//                                        Vec3 origin, Vec3 destination, BreathNode.Power power)
//  {
//    super(worldIn, shooter, origin, destination, power);
//    randomSeed = System.currentTimeMillis();
//    this.ignoreFrustumCheck = true; // makes sure that projectile renders even when its bounding box  is out of view.
//  }
//
//  // used by spawn code on the client side.  Relevant member variables are populated by a subsequent call to
//  //   readSpawnData()
//  public EntityBreathProjectileGhostOLD(World worldIn)
//  {
//    super(worldIn);
//    this.ignoreFrustumCheck = true; // makes sure that projectile renders even when its bounding box  is out of view.
//  }
//
//  public enum LifeStage {PRESTRIKE(3), STRIKE(2), POSTSTRIKE(6), DONE(0);
...
//    tagCompound.setInteger("LifeStage", renderStage.ordinal());
...
//      renderStage = LifeStage.values()[renderIndex];
//    }
//  }
//
//  @Override
...
//  {
//    return new Pair<LifeStage, Integer>(renderStage, timeInThisRenderStage);
//  }
//
//  private LifeStage renderStage = LifeStage.PRESTRIKE;
...
//      EntityBreathProjectileGhostOLD entity = new EntityBreathProjectileGhostOLD(world, dragon, origin, target, power);
