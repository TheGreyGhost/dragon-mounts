package info.ata4.minecraft.dragon.server.entity.helper.breath.plantspawners;
...
Second - the block chooses the appropriate class, and the class then looks at the iBlockState to identify the
  relevant type
This is done using the main type to generate sub-types

Registration of all types is done by the main utility which calls each class in turn
